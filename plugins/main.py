...
async def start_message(bot, message):
    ...
    button=InlineKeyboardMarkup([[
        InlineKeyboardButton("ꜱᴜᴩᴩᴏʀᴛ", url="https://t.me/Themortalclan"),
        InlineKeyboardButton("ᴜᴩᴅᴀᴛᴇꜱ", url="https://t.me/Miss_x_network")
        ],[            
...
async def media_info(bot, m): 
    ...
    if not md:
        buttons = [[
            InlineKeyboardButton("✨️ Support", url="https://t.me/Themortalclan"),
            InlineKeyboardButton("📢 Updates", url="https://t.me/Miss_x_network")
        ]]       
